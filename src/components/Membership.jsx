    ...
    <div className="bg-gray-100 pt-4 text-center">
      ...
      <div className="flex flex-row gap-24 justify-center">
        <div className="bg-white font-['Montserrat'] text-xs inline-flex flex-col gap-4 justify-center my-20 p-4 shadow-xs">
          ...
          <div className="flex flex-col gap-4">
            <div className="flex flex-row gap-4">
              ...
              <p>Stream movies in high-definition (HD) quality</p>
            </div>
            <div className="flex flex-row gap-4">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <p>Access to our vast library of movies and TV shows</p>
            </div>
            <div className="flex flex-row gap-4">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <p>Watch movies on up to two devices simultaneously</p>
            </div>
            <div className="flex flex-row gap-4">
              <svg
                xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="bg-white font-['Montserrat'] text-xs inline-flex flex-col gap-4 justify-center my-20 p-4 shadow-xs border-1 border-gray-600">
          ...
          <p className="text-2xl font-bold self-start ">
            $ 19.99 <span className="text-xs font-light">/ month</span>
          </p>
          ...
          <div className="flex flex-col gap-4">
            <div className="flex flex-row gap-4">
              ...
              <p>Stream movies in 4K Ultra HD quality</p>
            </div>
            <div className="flex flex-row gap-4">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <p>Exclusive access to premium content and early release</p>
            </div>
            <div className="flex flex-row gap-4">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <p>Watch movies on up to four devices simultaneously</p>
            </div>
            <div className="flex flex-row gap-4">
              <svg
                xmlns="http://www.w3.org/2000/svg"
